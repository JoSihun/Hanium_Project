...
class SentenceTokenizer(object):
    def __init__(self):
        ...
        self.stopwords = ['이기','대해','때문','여러','위해','대한','통해','로서','전반','한번','관련','또한','통한','우선','이후',
                          '그것','동안','시오''다른''거기']   # 나오면 안되는 단어들 적어줘야함
...
for field in field_dict:
    keyword_dict = {}
    Step = 0
    Final_Number = field_dict[field]
    for i in range(Repeat):   # 총 자소서 6586개
        f = open(f'{Path}/{i}.txt', 'r', encoding='utf-8')
        intro_data_list = f.readlines()
