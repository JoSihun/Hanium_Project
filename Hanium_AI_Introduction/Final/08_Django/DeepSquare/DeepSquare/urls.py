...
urlpatterns = [
    ...
    path('Test_page/', deepsquareapp.views.Test_page, name='Test_page'),
    ...
    path('reviewboard/', deepsquareapp.views.reviewboard, name='reviewboard'),
    path('reviewboard_writing/', deepsquareapp.views.reviewboard_writing, name='reviewboard_writing'),
    path('reviewboard_post/<int:pk>', deepsquareapp.views.reviewboard_post, name='reviewboard_post'),
    path('reviewboard_edit/<int:pk>', deepsquareapp.views.reviewboard_edit, name='reviewboard_edit'),
    path('reviewboard_delete/<int:pk>', deepsquareapp.views.reviewboard_delete, name='reviewboard_delete'),
]